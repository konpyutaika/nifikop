...
|accessPolicies|\[ \][AccessPolicy](/nifikop/docs/5_references/2_nifi_user#accesspolicy)| defines the list of access policies that will be granted to the group. |No| [] |
