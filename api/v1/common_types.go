...
type AccessPolicy struct {
	...
	// +kubebuilder:validation:Enum={"/system","/flow","/controller","/parameter-contexts","/provenance","/restricted-components","/policies","/tenants","/site-to-site","/proxy","/counters","/","/operation","/provenance-data","/data","/policies","/data-transfer","/connectors"}
