...
#      nodeAffinity:
      ...
      # podOverrides is merged onto the generated pod as a strategic merge patch (last resort, overrides win).
#      podOverrides:
#        spec:
#          hostUsers: false
#          containers:
...
| podOverrides          | [PodTemplateSpec](https://pkg.go.dev/k8s.io/api/core/v1#PodTemplateSpec)                     | Merged onto the pod generated by the operator as a strategic merge patch, after every other field above. Last-resort escape hatch for pod settings the operator does not expose; see [Pod overrides](../../3_manage_nifi/1_manage_clusters/1_deploy_cluster/2_nodes_configuration#pod-overrides). Not validated by the CRD schema. | No | nil|
