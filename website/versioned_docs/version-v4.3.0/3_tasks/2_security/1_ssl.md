...
As described in the [Reference section](../../5_references/1_nifi_cluster/6_listeners_config#sslsecrets), instead of using a self-signed certificate as CA, you can use an existing one.
