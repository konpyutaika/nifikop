...
func (r *NifiResourceReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	...
	if !v1.ClusterRefsEquals([]v1.ClusterReference{instance.Spec.ClusterRef, current.Spec.ClusterRef}) {
		...
		if _, err := r.RemoveNifiResource(instance, clientConfig); err != nil {
	...
	if !exist {
		...
		status, err := r.CreateNifiResource(instance, parameterContext, clientConfig)
		if err != nil {
	...
	if instance.Status.State == v1alpha1.ResourceStateOutOfSync {
		...
		status, err := r.SyncNifiResource(instance, parameterContext, clientConfig)
		if err != nil {
	...
	//TODO
	isOutOfSync, err := r.IsOutOfSyncNifiResource(instance, parameterContext, clientConfig)
	if err != nil {
	...
	requeue, err := r.CustomPostSyncActions(instance, clientConfig, ctx, current.Status)
	if err != nil {
...
func (r *NifiResourceReconciler) CreateNifiResource(resource *v1alpha1.NifiResource, parameterContext *v1.NifiParameterContext, clientConfig *clientconfig.NifiConfig) (*v1alpha1.NifiResourceStatus, error) {
	switch resource.Spec.Type {
	case v1.ProcessGroup:
		return processgroup.CreateProcessGroup(resource, parameterContext, clientConfig)
	default:
		return nil, errors.New("Invalid Type for NifiResource")
	}
}

func (r *NifiResourceReconciler) RemoveNifiResource(resource *v1alpha1.NifiResource, clientConfig *clientconfig.NifiConfig) (*v1alpha1.NifiResourceStatus, error) {
	switch resource.Spec.Type {
	case v1.ProcessGroup:
		return processgroup.RemoveProcessGroup(resource, clientConfig)
	default:
		return nil, errors.New("Invalid Type for NifiResource")
	}
}

func (r *NifiResourceReconciler) SyncNifiResource(resource *v1alpha1.NifiResource, parameterContext *v1.NifiParameterContext, clientConfig *clientconfig.NifiConfig) (*v1alpha1.NifiResourceStatus, error) {
	switch resource.Spec.Type {
	case v1.ProcessGroup:
		return processgroup.SyncProcessGroup(resource, parameterContext, clientConfig)
	default:
		return nil, errors.New("Invalid Type for NifiResource")
	}
}

func (r *NifiResourceReconciler) IsOutOfSyncNifiResource(resource *v1alpha1.NifiResource, parameterContext *v1.NifiParameterContext, clientConfig *clientconfig.NifiConfig) (bool, error) {
	switch resource.Spec.Type {
	case v1.ProcessGroup:
		return processgroup.IsOutOfSyncResource(resource, clientConfig, parameterContext)
	default:
		return false, errors.New("Invalid Type for NifiResource")
	}
}
...
func (r *NifiResourceReconciler) checkFinalizers(ctx context.Context, resource *v1alpha1.NifiResource,
...
func (r *NifiResourceReconciler) finalizeNifiResource(resource *v1alpha1.NifiResource, config *clientconfig.NifiConfig) error {
	...
	if exists {
		...
		if _, err = r.RemoveNifiResource(resource, config); err != nil {
			return err
		}
