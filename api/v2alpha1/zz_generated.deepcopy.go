...
func (in *AzureDevOpsConfig) DeepCopyInto(out *AzureDevOpsConfig) {
	*out = *in
	...
	if in.AuthenticationStrategy != nil {
		...
		*out = new(AzureDevOpsAuthenticationStrategy)
		**out = **in
	}
	if in.OAuthTokenProviderId != nil {
		in, out := &in.OAuthTokenProviderId, &out.OAuthTokenProviderId
		*out = new(string)
		**out = **in
	}
...
func (in *NifiRegistryClientSpec) DeepCopyInto(out *NifiRegistryClientSpec) {
	*out = *in
	...
	if in.AzureDevOpsConfig != nil {
		in, out := &in.AzureDevOpsConfig, &out.AzureDevOpsConfig
		*out = new(AzureDevOpsConfig)
		(*in).DeepCopyInto(*out)
	}
}
