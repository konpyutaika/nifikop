...
- Setup NiFiKop by following the instructions in the [Installation guide](../../2_setup/1_getting_started).
- Deploy the [Simple NiFi](../../2_setup/1_getting_started#easy-way-installing-with-helm) sample cluster.
