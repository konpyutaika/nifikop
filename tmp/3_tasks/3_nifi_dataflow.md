...
If you want more details about the design, just have a look on the [design page](../1_conceptsncepts/2_design_principes.md#dataflow-lifecycle-management)
...
:::important
More information about `Spec.UpdateStrategy` [here](../5_referencesrences/5_nifi_dataflow.md#dataflowupdatestrategy)
:::

[NifiDataflow]: ../5_referencesrences/5_nifi_dataflow.md
[NifiRegistryClient]: ../5_referencesrences/3_nifi_registry_client.md
[NifiParameterContext]: ../5_referencesrences/4_nifi_parameter_context.md