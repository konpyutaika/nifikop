...
| seccompProfile        | [SeccompProfile](https://godoc.org/k8s.io/api/core/v1#SeccompProfile)                        | sets the used SeccompProfile | No | [SeccompProfileTypeRuntimeDefault](https://godoc.org/k8s.io/api/core/v1#SeccompProfileType)|
| securityContext       | [SecurityContext](https://godoc.org/k8s.io/api/core/v1#SecurityContext)                      | sets the used SecurityContext | No | sets AllowPrivilegeEscalation to false and drops all capabilities|
