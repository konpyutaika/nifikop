...
- Setup NiFiKop by following the instructions in the [Installation guide](/nifikop/docs/2_setup/1_getting_started).
- Deploy the [Simple NiFi](/nifikop/docs/2_setup/1_getting_started#easy-way-installing-with-helm) sample cluster.
- Review the [Node](/nifikop/docs/5_references/1_nifi_cluster/4_node) references doc. 

## About this task

The [Simple NiFi](/nifikop/docs/2_setup/1_getting_started#easy-way-installing-with-helm) example consists of a three nodes NiFi cluster. 
...
For this task, we will simply add a node with the same configuration than the other ones, if you want to know more about how to add a node with an other configuration let's have a look to the [Node configuration](/nifikop/docs/3_tasks/1_nodes_configuration) documentation page.

1. Add and run the following dataflow example :  [scaling.xml](/nifikop/files/3_tasks/1_nifi_cluster/2_cluster_scaling/scaling.xml)

![Scaling dataflow](/nifikop/img/3_tasks/1_nifi_cluster/2_cluster_scaling/scaling_dataflow.png)

2. Add a new node to the list of `NifiCluster.Spec.Nodes` field, by following the [Node object definition](/nifikop/docs/5_references/1_nifi_cluster/4_node) documentation:
...
![Scale up, cluster list](/nifikop/img/3_tasks/1_nifi_cluster/2_cluster_scaling/scaleup_cluster_list.png)
...
:::tip
The list of decommision's step and their corresponding value for the `Nifi Cluster.Status.Node State.Graceful ActionState.ActionStep` field is described into the [Node State page](/nifikop/docs/5_references/1_nifi_cluster/5_node_state#actionstep)
:::
