...
- [PR #101](https://github.com/konpyutaika/nifikop/pull/101) - **[Operator]** Handle case where `Certificate` is destroyed before `NifiUser` to avoid Nifi user controller getting stuck on deletion
