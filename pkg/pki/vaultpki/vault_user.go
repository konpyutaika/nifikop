...
func (v *vaultPKI) ReconcileUserCertificate(ctx context.Context, user *v1alpha1.NifiUser, scheme *runtime.Scheme) (*pkicommon.UserCertificate, error) {
...
func ensureVaultSecret(client *vaultapi.Client, userCert *pkicommon.UserCertificate, user *v1alpha1.NifiUser) error {
...
func (v *vaultPKI) FinalizeUserCertificate(ctx context.Context, user *v1alpha1.NifiUser) (err error) {
	client, err := v.getClient()
	if err != nil {
		return
	}
