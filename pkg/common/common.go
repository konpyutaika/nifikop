...
type RequeueConfig struct {
	...
	ParameterContextSecretRequeueInterval int
...
func NewRequeueConfig() *RequeueConfig {
	return &RequeueConfig{
		...
		ParameterContextSecretRequeueInterval: util.MustConvertToInt(util.GetEnvWithDefault("PARAMETER_CONTEXT_SECRET_REQUEUE_INTERVAL", "15"), "PARAMETER_CONTEXT_SECRET_REQUEUE_INTERVAL"),
